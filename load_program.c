 ...
 */
 ...
 
 {
    ...
    */
    ...
    for(int i = text_pg1; i < li.t_npg; i++){
      region1_page_table[i].pfn = allocate_frame();
      region1_page_table[i].valid = 1;
      region1_page_table[i].prot = PROT_READ | PROT_WRITE;
    }
    ...
    */
    ...
    for(int i = data_pg1; i < data_npg; i++){
      region1_page_table[i].pfn = allocate_frame();
      region1_page_table[i].valid = 1;
      region1_page_table[i].prot = PROT_READ | PROT_WRITE;
    }
    ...
    */
    ...
    for(int i = 0; i < stack_npg; i++){
      region1_page_table[VMEM_1_LIMIT - i].pfn = allocate_frame();
      region1_page_table[VMEM_1_LIMIT - i].valid = 1;
      region1_page_table[VMEM_1_LIMIT - i].prot = PROT_READ | PROT_WRITE;
    }
